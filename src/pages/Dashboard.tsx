...
type Page = 'home' | 'animals' | 'pens' | 'foods' | 'costs' | 'sales' | 'cashflow' | 'reports' | 'users';
  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatCard title="Animais Ativos" value="0" icon={Beef} color="blue" />
        <StatCard title="Baias Ocupadas" value="0" icon={Grid3x3} color="green" />
        <StatCard title="Custo Total Mês" value="R$ 0,00" icon={DollarSign} color="red" />
        <StatCard title="Vendas do Mês" value="R$ 0,00" icon={ShoppingCart} color="emerald" />
      </div>

      <div className="bg-white rounded-xl shadow-sm p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Bem-vindo ao CTE Manager</h2>
        <p className="text-gray-600">
          Sistema completo de gestão para Centro de Terminação de Bovinos. Use o menu lateral para navegar entre os módulos.
        </p>
      </div>
    </div>
  );
